...
def patient_update():
    print('Modify patient record.')
    # messagebox.showinfo("Information", "Not supported (Future enhancement)")
    treatment_list = ["Paracetamol - 650 BDS", "PAN D 40 mg"]
    display_diagnosis("ABC", treatment_list)
